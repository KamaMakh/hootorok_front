<template>
  <q-page class="text-center">
    ...
    <div>
      ...
      <div class="flex justify-around text-justify">
        <p class="contacts-text q-pa-md text-body2 text-grey-7">
    ...
    <div class="q-pb-md">
      ...
      />
      <span
        class="block text-body2 q-pb-md text-grey-7"
        v-text="$t('contacts')"
      />
...
export default {
  ...
  data() {
    return {
      ...
      contactNumbers: ['8(918)692-27-28', '7(918)190-15-17', '7(918)345-90-58',
